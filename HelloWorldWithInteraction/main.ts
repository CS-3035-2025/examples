...
panel.border = "black";
panel.padding = 20;
panel.layoutMethod = new Layout.WrapRowLayout({ gap: 10 });
//panel.layoutMethod = new Layout.FillRowLayout({ gap: 10 }); //try a different layout
...
root.addEventListener("resize", (e) => {console.log(root.layoutWidth)});
